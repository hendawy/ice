...
<body>
<div class="" style="margin: 20px 30px;" ng-controller="resbreakdownCtrl">
  ...
  <div class="list">
    ...
    <table>
      ...
      <tr>
        ...
        <th rowspan="2" ng-click="order('name')">Total Number of Reserved Instances</th>
      </tr>
      </thead>
      <tbody>
      <tr ng-repeat="row in data | filter:filter_legend" class="{{getTrClass($index)}}">
        ...
        <td >
          <span ng-show="legend_usage_cost == 'cost'"></span>{{row.value}}
        </td>
      </tr>
      </tbody>
    </table>
